...
<head>
    ...
    <title>Neon Green Glitch Text</title>
    <style>
        body {
        ...
        .glitch-text::before {
            color: #009900; /* Darker shade of green for the glitch effect */
            z-index: -2;
...
<body>
    <div class="glitch-text" data-text="Neon Green Glitch Text">Neon Green Glitch Text</div>
</body>
</html>
